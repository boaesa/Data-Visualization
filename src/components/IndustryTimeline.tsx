...
const YEARS = Array.from({ length: Math.floor((2023 - 1965) / 5) + 1 }, (_, i) => 1965 + i * 5);
...
const getYearY = (year: number) => {
  ...
  if (year <= 1990) {
    ...
    percent = 0.50 + ((year - 2010) / (2023 - 2010)) * 0.50;
  }
...
const SOCIAL_ISSUES = [
  ...
  { category: 'agri', year: 1995, title: 'WTO 출범', desc: '농산물 시장 개방 및 농어촌특별세 도입', img: 'https://placehold.co/300x200?text=Agri' },
  { category: 'agri', year: 2003, title: '한·칠레 FTA', desc: '첫 자유무역협정 타결로 인한 시장 개방', img: 'https://placehold.co/300x200?text=Agri' },
  { category: 'agri', year: 2007, title: '한미 FTA', desc: '농축산물 시장 추가 개방 및 경쟁 심화', img: 'https://placehold.co/300x200?text=Agri' },
  { category: 'agri', year: 2010, title: '구제역 대유행', desc: '축산업 사상 최악의 가축 전염병 피해', img: 'https://placehold.co/300x200?text=Agri' },
  { category: 'agri', year: 2015, title: '쌀 시장 전면개방', desc: '쌀 관세화 도입 및 시장 전면 개방', img: 'https://placehold.co/300x200?text=Agri' },
  { category: 'agri', year: 2020, title: '귀농귀촌 증가', desc: '코로나19 영향으로 인한 인구 환류 현상', img: 'https://placehold.co/300x200?text=Agri' },
  { category: 'agri', year: 2022, title: '고령화율 49% 돌파', desc: '농가 인력난 및 생산 기반 약화 심화', img: 'https://placehold.co/300x200?text=Agri' },

  // --- 2. 제조업 (manu) ---
  { category: 'manu', year: 1973, title: '중화학공업화 선언', desc: '포항제철·울산공단 등 중공업 육성', img: 'https://placehold.co/300x200?text=Manu' },
  { category: 'manu', year: 1979, title: '2차 오일쇼크', desc: '에너지 가격 급등으로 제조원가 부담', img: 'https://placehold.co/300x200?text=Manu' },
  { category: 'manu', year: 1986, title: '3저 호황', desc: '저금리·저유가·저달러로 수출 비약적 증가', img: 'https://placehold.co/300x200?text=Manu' },
  { category: 'manu', year: 1988, title: '제조업 정점기', desc: '서울올림픽 전후 산업 경쟁력 최대치', img: 'https://placehold.co/300x200?text=Manu' },
  { category: 'manu', year: 1992, title: '한중수교', desc: '중국 시장 개척 및 생산기지 이전 가속', img: 'https://placehold.co/300x200?text=Manu' },
  { category: 'manu', year: 1997, title: 'IMF 구조조정', desc: '재벌 빅딜 및 고용 구조의 근본적 변화', img: 'https://placehold.co/300x200?text=Manu' },
  { category: 'manu', year: 2001, title: '중국 WTO 가입', desc: '생산기지의 대거 중국 이전 시작', img: 'https://placehold.co/300x200?text=Manu' },
  { category: 'manu', year: 2008, title: '글로벌 금융위기', desc: '전 세계적 금융 위기에 따른 파급 효과', img: 'https://placehold.co/300x200?text=Manu' },
  { category: 'manu', year: 2010, title: '반도체·자동차 반등', desc: '글로벌 위기 이후 주력 산업의 재도약', img: 'https://placehold.co/300x200?text=Manu' },
  { category: 'manu', year: 2016, title: '조선업 구조조정', desc: '글로벌 수주 절벽에 따른 대규모 감원', img: 'https://placehold.co/300x200?text=Manu' },
  { category: 'manu', year: 2019, title: '일본 수출규제', desc: '소재·부품·장비(소부장) 국산화 본격화', img: 'https://placehold.co/300x200?text=Manu' },
  { category: 'manu', year: 2020, title: '비대면 IT 수요', desc: '코로나19발 비대면 특수로 인한 전자기기 수요 급증', img: 'https://placehold.co/300x200?text=Manu' },
  { category: 'manu', year: 2022, title: '반도체 사이클 급감', desc: '미국 인플레이션 감축법 등 글로벌 공급망 재편', img: 'https://placehold.co/300x200?text=Manu' },

  // --- 3. 건설업 (const) ---
  { category: 'const', year: 1968, title: '경부고속도로 착공', desc: '국토 대동맥 건설 및 토목 사업 본격화', img: 'https://placehold.co/300x200?text=Const' },
  { category: 'const', year: 1973, title: '중동 건설붐', desc: '해외 건설 수주를 통한 외화 획득', img: 'https://placehold.co/300x200?text=Const' },
  { category: 'const', year: 1982, title: '88올림픽 유치', desc: '88올림픽 유치에 따른 도시 개발 가속', img: 'https://placehold.co/300x200?text=Const' },
  { category: 'const', year: 1989, title: '1기 신도시 건설', desc: '주택 200만호 건설 및 수도권 확장', img: 'https://placehold.co/300x200?text=Const' },
  { category: 'const', year: 1997, title: 'IMF 건설사 부도', desc: '외환위기로 인한 건설 경기 급랭', img: 'https://placehold.co/300x200?text=Const' },
  { category: 'const', year: 2003, title: '행정수도 이전 추진', desc: '균형 발전 정책으로 인한 충청권 개발', img: 'https://placehold.co/300x200?text=Const' },
  { category: 'const', year: 2008, title: '글로벌 금융위기', desc: '미분양 급증 및 건설 경기 침체 시작', img: 'https://placehold.co/300x200?text=Const' },
  { category: 'const', year: 2014, title: '부동산 부양책', desc: 'LTV 완화 등 경기 활성화 대책', img: 'https://placehold.co/300x200?text=Const' },
  { category: 'const', year: 2021, title: '3기 신도시 발표', desc: '공급 확대를 통한 주택 시장 안정화 추진', img: 'https://placehold.co/300x200?text=Const' },
  { category: 'const', year: 2022, title: '레고랜드·PF 부실', desc: '금리 인상에 따른 건설 금융 위기 확산', img: 'https://placehold.co/300x200?text=Const' },

  // --- 4. 보건 및 사회복지 (health) ---
  { category: 'health', year: 1989, title: '전국민 의료보험', desc: '보건 서비스 접근성의 비약적 향상', img: 'https://placehold.co/300x200?text=Health' },
  { category: 'health', year: 2000, title: '의약분업 시행', desc: '진료와 조제의 분리 및 복지 체계 정비', img: 'https://placehold.co/300x200?text=Health' },
  { category: 'health', year: 2008, title: '노인장기요양보험', desc: '요양 인력 수요의 폭발적 증가 기점', img: 'https://placehold.co/300x200?text=Health' },
  { category: 'health', year: 2011, title: '무상보육 시행', desc: '국가 책임 보육 시스템 강화', img: 'https://placehold.co/300x200?text=Health' },
  { category: 'health', year: 2013, title: '기초연금 확대', desc: '노인 빈곤 해소를 위한 복지 예산 증대', img: 'https://placehold.co/300x200?text=Health' },
  { category: 'health', year: 2017, title: '문재인 케어', desc: '건강보험 보장성 강화 및 비급여 축소', img: 'https://placehold.co/300x200?text=Health' },
  { category: 'health', year: 2019, title: '치매국가책임제', desc: '고령화 대응 공공 돌봄 인프라 확충', img: 'https://placehold.co/300x200?text=Health' },
  { category: 'health', year: 2020, title: '코로나19 방역', desc: '의료 및 돌봄 인력의 중요성 재조명', img: 'https://placehold.co/300x200?text=Health' },
  { category: 'health', year: 2022, title: '요양보호사 수요 폭증', desc: '초고령사회 진입에 따른 돌봄 서비스 부족', img: 'https://placehold.co/300x200?text=Health' },

  // --- 5. 전문, 과학 및 기술 (tech) ---
  { category: 'tech', year: 2004, title: 'R&D 투자 확대', desc: '국가 R&D 투자 GDP 2%대 진입', img: 'https://placehold.co/300x200?text=Tech' },
  { category: 'tech', year: 2009, title: '녹색성장 R&D', desc: '친환경 및 에너지 기술 투자 집중', img: 'https://placehold.co/300x200?text=Tech' },
  { category: 'tech', year: 2013, title: '창조경제 추진', desc: 'ICT 융합 및 신산업 육성 정책', img: 'https://placehold.co/300x200?text=Tech' },
  { category: 'tech', year: 2016, title: '4차 산업혁명 담론', desc: 'AI, 빅데이터 중심의 산업 구조 변화 시작', img: 'https://placehold.co/300x200?text=Tech' },
  { category: 'tech', year: 2019, title: '데이터·AI 정책', desc: '디지털 전환 가속화를 위한 국가 전략', img: 'https://placehold.co/300x200?text=Tech' },
  { category: 'tech', year: 2020, title: '디지털 뉴딜', desc: '비대면 기술 및 인프라 대규모 투자', img: 'https://placehold.co/300x200?text=Tech' },
  { category: 'tech', year: 2022, title: '반도체 인력난', desc: '첨단 기술 분야 핵심 인재 확보 경쟁 심화', img: 'https://placehold.co/300x200?text=Tech' },

  // --- 6. 예술, 스포츠, 여가 (art) ---
  { category: 'art', year: 2002, title: '한일 월드컵', desc: '스포츠 산업 및 국가 브랜드 이미지 도약', img: 'https://placehold.co/300x200?text=Art' },
  { category: 'art', year: 2004, title: '주5일제 전면시행', desc: '여가 및 여행 서비스 수요 폭발적 증가', img: 'https://placehold.co/300x200?text=Art' },
  { category: 'art', year: 2012, title: 'K-POP 글로벌 약진', desc: '싸이 강남스타일 등 콘텐츠 수출 본격화', img: 'https://placehold.co/300x200?text=Art' },
  { category: 'art', year: 2018, title: '평창동계올림픽', desc: '동계 스포츠 및 지역 관광 활성화', img: 'https://placehold.co/300x200?text=Art' },
  { category: 'art', year: 2019, title: 'K-콘텐츠 정점', desc: 'BTS, 기생충 등 글로벌 문화 시장 석권', img: 'https://placehold.co/300x200?text=Art' },
  { category: 'art', year: 2020, title: '공연·스포츠 직격타', desc: '코로나19로 인한 오프라인 여가 산업 침체', img: 'https://placehold.co/300x200?text=Art' },
  { category: 'art', year: 2021, title: 'OTT 호황', desc: '오징어게임 등 비대면 콘텐츠 소비 급증', img: 'https://placehold.co/300x200?text=Art' },
  { category: 'art', year: 2022, title: '엔데믹 공연 재개', desc: '보복 소비로 인한 공연·여행 시장 회복', img: 'https://placehold.co/300x200?text=Art' }
];
