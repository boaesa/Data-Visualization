...
// Add the button: "직업 리스트 아래에 가운데 정렬로 **AI 대체 가능성 높은 직업** 버튼 만들고 누르면 위 직업만 뜨도록 필터 버튼 만들어줘. 누르면 black 컬러 됨."
// Replaces the header part
const targetHeader = `<div className="w-full px-2 md:px-4 mb-2 flex justify-center items-center max-w-7xl mx-auto relative min-h-[28px]">
...
const newHeader = `<div className="w-full px-2 md:px-4 mb-2 flex flex-col justify-center items-center max-w-7xl mx-auto relative min-h-[28px]">
          ...
          <button 
             ...
             className={\`px-4 py-1.5 rounded-full text-xs font-bold transition-all duration-200 shadow-sm border \${
               aiFilterActive 
...
console.log('injected ai filter');
